# OSS Insight Extension

This extension provides a quick way to analyze a GitHub user or repositories on [OSS Insight](https://ossinsight.io).
...
The project functions just like a regular Vite project.
